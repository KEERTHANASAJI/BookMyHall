  ...
  const fetchPendingBookings = async () => {
    try {
      ...
      if (result.success) {
        ...
        const pendingBookings = result.data.filter(booking => booking.status === 'pending');
    ...
    return (
      <div className="total-bookings-container">
        <div className="error-container">
          ...
          <h2>Error Loading Pending Requests</h2>
          <p>{error}</p>
          <button 
...
const handleDeleteBooking = async (bookingId) => {
  ...
  return (
    <div className="total-bookings-container">
      ...
      <p>Here are the pending booking requests waiting for approval:</p>
      <button 
      ...
      <div className="refresh-section">
        ...
        <span className="last-updated">Showing {bookings.length} pending requests</span>
      </div>
